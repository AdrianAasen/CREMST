...
[4] [Limitations for adaptive quantum state tomography in the presence of detector noise](https://journals.aps.org/pra/abstract/10.1103/3q13-xpc8) Phys. Rev. A **114**, 012414 (2026)
...
#### ▸ `Optimal_state_tomogoraphy_scaling/` (Limitations for adaptive quantum state tomography in the presence of detector noise)
