...
sim_dict ={
    'n_qubits': 16,
    'n_QST_shots_total': 10**6, # This is the number of shots for each two-point correlator QST.
    'n_QDT_shots': 10**5,
...
random_two_pont_array = ot.generate_random_pairs_of_qubits(sim_dict["n_qubits"], 20)
...
with open('qrem_default.pkl', 'wb') as f:
